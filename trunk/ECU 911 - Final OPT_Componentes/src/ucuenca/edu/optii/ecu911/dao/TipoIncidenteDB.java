...
public class TipoIncidenteDB {
    ...
    public ArrayList listar(String ciudad, String descripcion) throws SQLException {
        OperacionesBase db = new OperacionesBase();
        String query = "SELECT tipo_entidad FROM entidad_cooperativa ec,entidad_tipincidente,"
                + "tipo_incidente ti WHERE ec.id=identidad and ti.id=id_tipoinc and ciudad='" + ciudad + "' "
